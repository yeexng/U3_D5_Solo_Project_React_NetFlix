...
import { Card , Row, Col, Container, ListGroup, Spinner, Badge} from "react-bootstrap/";
...
const MovieDetails = () =>{
    ...
    const fetchMovie = async () =>{
        try{
            let response = await fetch("http://www.omdbapi.com/?apikey=bda9b329&i=" + params.movieId)
